...
import { StyleSheet, Text, TouchableHighlight, View, PickerIOS } from "react-native";
import DateTimePicker from "@react-native-community/datetimepicker";
import Modal from "./Modal";
import { isIphoneX } from "./utils";
import { useTheme } from 'context';

export const BACKGROUND_COLOR_LIGHT = '#eaeaea';
export const BACKGROUND_COLOR_DARK = '#252a34';
export const BORDER_COLOR = '#c7c7cc66';
export const BORDER_RADIUS = 13;
export const BUTTON_FONT_WEIGHT = "normal";
export const BUTTON_FONT_COLOR = '#252a34';
export const BUTTON_FONT_SIZE = 20;
export const HIGHLIGHT_COLOR_DARK = '#343B49';
export const HIGHLIGHT_COLOR_LIGHT = 'white';
export const TITLE_FONT_SIZE = 20;
export const TITLE_COLOR = '#eaeaea';
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <HeaderComponent label={headerTextIOS} hstyle={headerStyle} />
          <PickerComponent
            {...otherProps}
...
export const Header = ({ label, style = headerStyles }) => {
  ...
  return (
    <View style={style.root}>
      <Text style={{ ...style.text, color: colors.primary }}>{label}</Text>
    </View>
  );
};
...
export const CancelButton = ({
  ...
  return (
    <TouchableHighlight
      ...
      onPress={onPress}
    >
      <Text style={{ ...style.text, color: colors.secondary }}>{label}</Text>
    </TouchableHighlight>
  );
};
