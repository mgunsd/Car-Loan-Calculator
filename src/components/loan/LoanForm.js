...
import { ScrollBlur, Spacer, Heading, Label, LinkText, PrimaryButton, AltButton } from 'src/components';

//import { Screen, Button, Container, Title, Label, ScrView } from '../ui';
//import { MonthlyPayCard } from './MonthlyPayCard';
import { Context as LoanContext } from 'src/context/LoanContext';
//import { InputCard } from './InputCard';
//import CurrencyInput from './CurrencyInput';
//import ModalDatePicker from './ModalDatePicker'
//import { PeriodToggle } from '../loan/PeriodToggle';
import { InputCard, CurrencyInput, PeriodToggle, ARRANGEMENT_FEE, COMPLETION_FEE, DEPOSIT_PERCENT } from 'src/components/loan';
...
export const LoanForm = () => {
  ...
  return (
    ...
    <ScrollBlur tint={colors.base} tintt={colors.card}>
      ...
      {!isVisible && <PrimaryButton text='Calculate' style={{ marginVertical: 35, width: '85%', height: 50, }} onPress={() => setVisible(true)} />}
